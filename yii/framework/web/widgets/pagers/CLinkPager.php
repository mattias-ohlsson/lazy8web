...
class CLinkPager extends CBasePager
{
	...
	public function init()
	{
		if($this->nextPageLabel===null)
			$this->nextPageLabel=Yii::t('lazy8','Next &gt;');
		if($this->prevPageLabel===null)
			$this->prevPageLabel=Yii::t('lazy8','&lt; Previous');
		if($this->firstPageLabel===null)
			$this->firstPageLabel=Yii::t('lazy8','&lt;&lt; First');
		if($this->lastPageLabel===null)
			$this->lastPageLabel=Yii::t('lazy8','Last &gt;&gt;');
		if($this->header===null)
			$this->header=Yii::t('lazy8','Go to page: ');
